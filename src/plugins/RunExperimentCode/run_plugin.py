"""
This script is called by the plugin-wrapper, RunExperimentCode.js, which passes down the
...
from RunExperimentCode import RunExperimentCode
...
plugin = RunExperimentCode(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
