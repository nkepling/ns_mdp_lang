"""
This script is called by the plugin-wrapper, ExperimentCodeGenerator.js, which passes down the
...
from ExperimentCodeGenerator import ExperimentCodeGenerator
...
plugin = ExperimentCodeGenerator(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
